...
// FileWriterApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFileWriterAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CFileWriterAppApp

CFileWriterAppApp::CFileWriterAppApp()
{
...
// Единственный объект CFileWriterAppApp

CFileWriterAppApp theApp;


// Инициализация CFileWriterAppApp

BOOL CFileWriterAppApp::InitInstance()
{
